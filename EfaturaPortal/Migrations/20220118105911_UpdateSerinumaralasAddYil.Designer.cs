...
namespace EfaturaPortal.Migrations
{
    ...
    [Migration("20220118105911_UpdateSerinumaralasAddYil")]
    partial class UpdateSerinumaralasAddYil
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EfaturaPortal.Models.Fatura", b =>
                {
                    ...
                    b.Property<float>("Artirim")
                        .HasColumnType("real");

                    b.Property<Guid>("CarilerId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<float>("DigerVergilerToplam")
                        .HasColumnType("real");

                    b.Property<string>("Doviz")
                        .HasColumnType("nvarchar(max)");

                    b.Property<float>("DovizKuru")
                        .HasColumnType("real");
                    ...
                    b.Property<string>("OdemeSekliAdi")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OdemeSekliKodu")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("OdemeTarihi")
                        .HasColumnType("datetime2");

                    b.Property<float>("OdenecekTutar")
                        .HasColumnType("real");
                    ...
                    b.Property<float>("TevkifatToplam")
                        .HasColumnType("real");

                    b.Property<float>("Toplam")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("EfaturaPortal.Models.FaturaSatir", b =>
                {
                    ...
                    b.Property<int?>("IstisnaKodlariId")
                        .HasColumnType("int");
                    ...
                    b.Property<float>("KdvTutar")
                        .HasColumnType("real");

                    b.Property<float>("KdvliTutar")
                        .HasColumnType("real");
                    ...
                    b.Property<int>("OlcuBirimleriId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IstisnaKodlariId");

                    b.HasIndex("OlcuBirimleriId");

                    b.ToTable("FaturaSatirs");
                });

            modelBuilder.Entity("EfaturaPortal.Models.FaturaSatirKdvler", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("FaturaSatirId");

                    b.ToTable("FaturaSatirKdvlers");
                });
            ...
            modelBuilder.Entity("EfaturaPortal.Models.OdemeTurleri", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EfaturaPortal.Models.VergiKodlari", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EfaturaPortal.Models.Fatura", b =>
                {
                    ...
                    b.HasOne("EfaturaPortal.Models.Firmalar", "Firmalar")
                        .WithMany()
            ...
            modelBuilder.Entity("EfaturaPortal.Models.FaturaSatir", b =>
                {
                    ...
                    b.HasOne("EfaturaPortal.Models.IstisnaKodlari", "IstisnaKodlari")
                        .WithMany()
                        .HasForeignKey("IstisnaKodlariId");

                    b.HasOne("EfaturaPortal.Models.OlcuBirimleri", "OlcuBirimleri")
                        .WithMany()
                        .HasForeignKey("OlcuBirimleriId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Fatura");

                    b.Navigation("IstisnaKodlari");

                    b.Navigation("OlcuBirimleri");
                });

            modelBuilder.Entity("EfaturaPortal.Models.FaturaSatirKdvler", b =>
                {
                    b.HasOne("EfaturaPortal.Models.FaturaSatir", "FaturaSatir")
                        .WithMany()
                        .HasForeignKey("FaturaSatirId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FaturaSatir");
                });
